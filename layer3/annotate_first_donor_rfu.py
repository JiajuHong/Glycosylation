#!/usr/bin/env python3
"""第三层人工检查工具：绘制指定反应的供体 RFU 和受体 O4 局部标注。

Examples (row numbers are 1-based data rows, excluding the header):
  python -m layer3.annotate_first_donor_rfu --rows 1
  python -m layer3.annotate_first_donor_rfu --rows 1,3,8-12
  python -m layer3.annotate_first_donor_rfu --all
"""
